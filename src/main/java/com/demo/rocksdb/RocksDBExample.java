        ...
        try (final Options options = new Options().setCreateIfMissing(true)) {
            try (final RocksDB rocksDB = RocksDB.open(options, dbPath)) {
                ...
                {                
                	...
                	System.out.println("finished compacting, check the size of the DB");
                }
                else
                {
	             ...
	             // 写入key/value
	                ...
	                for (int counter=0;counter<1000000;counter++)
	                {
	                	...
	                	rocksDB.put(("SecondKey" + rand_int1).getBytes(), "SecondValue".getBytes());
	                }
	                System.out.println("finished putting values, check the size of the DB");
                }
